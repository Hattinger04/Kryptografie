...
def DoReverseCipher():
    ...
    cipher = plain[::-1]#erase this line, its only purpose is to
...
def ColTransKeyChanged(var, index, mode):
    ...
    pass
    cipher = columnar_transposition.encrypt(plain, Key1)#erase this line, its only purpose is to
    #avoid an error when running the script for the first time
    explanation = ""#erase this line, its only purpose is to
    #avoid an error when running the script for the first time
    TextCiph.insert("1.0", cipher)
...
def DisrColTransKey2Changed(var, index, mode):
    ...
    pass
    cipher = columnar_transposition.encrypt(plain) #erase this line, its only purpose is to
